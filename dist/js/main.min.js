	...
	_createClass(Whoops, [{
		...
		value: function _createElements() {
			...
			return new Promise(function (resolve, reject) {
				_this.whoopsContainerEl = document.createElement('div');
				_this.whoopsContainerEl.classList.add('whoops-container');
				_this.whoopsContainerEl.setAttribute('role', 'alert');
				_this.whoopsContainerEl.setAttribute('aria-hidden', true);

				_this.whoopsEl = document.createElement('div');
				_this.whoopsEl.classList.add('whoops');

				_this.whoopsContainerEl.appendChild(_this.toastEl);
				document.body.appendChild(_this.whoopsContainerEl);
		...
		value: function _addEventListeners() {
			...
			document.querySelector('.whoops-btn--close').addEventListener('click', function () {
				_this2._close();
			});

			if (this.options.customButtons) {
				var customButtonsElArray = Array.prototype.slice.call(document.querySelectorAll('.whoops-btn--custom'));
		...
		value: function _close() {
			...
			return new Promise(function (resolve, reject) {
				_this3.whoopsContainerEl.setAttribute('aria-hidden', true);
				setTimeout(function () {
					_this3.whoopsEl.innerHTML = '';
					_this3.whoopsEl.classList.remove('default', 'success', 'warning', 'danger');
		...
		value: function _init() {
			...
			Promise.resolve().then(function () {
				if (_this4.whoopsContainerEl) {
					return Promise.resolve();
				}
				return _this4._createElements();
			}).then(function () {
				if (_this4.whoopsContainerEl.getAttribute('aria-hidden') == 'false') {
